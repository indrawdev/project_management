...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo config_item('base_ext');?>packages/sencha-charts/build/crisp/resources/sencha-charts-all.css">
	...
	<script type="text/javascript" src="<?php echo config_item('base_lokal');?>ext-locale-id.js?cb=<?php echo time()?>"></script>
	<script type="text/javascript" src="<?php echo config_item('base_ext');?>packages/sencha-charts/build/sencha-charts.js"></script>
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>dashboard.js?cb=<?php echo time()?>"></script>
</head>
<body>
</body>
</html>