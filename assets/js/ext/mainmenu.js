...
Ext.onReady(function() {
	...
	function buatMenu() {
		...
		var xTxt = '';
		if (Ext.Date.format(new Date(), 'Y') === '2018') {
			xTxt = 'Copyright &copy; '+ Ext.Date.format(new Date(), 'Y') +' ~ Web Developer - Indra Pramana';
		}
		else {
			xTxt = 'Copyright &copy; 2018 - '+ Ext.Date.format(new Date(), 'Y') +' ~ Web Developer - Indra Pramana';
		}
